...
public class ListNewFestivalActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_new_festival);
        ...
        final RecyclerView recyclerView = (RecyclerView) findViewById(R.id.RecyclerViewNewFestival);
        ...
        festivalCollection.whereGreaterThan("dateFestival", timestamp2)
                .get()
